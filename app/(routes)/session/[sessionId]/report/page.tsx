...
import PremiumFeatureFallback from "@/components/custom/PremiumFeatureFallback";
  ...
  return (
    <Protect
      condition={(has) => {
        ...
        return isHealthEssentials || isPremiumCare; // Returns true if either Silver OR Gold
      }}
      fallback={<PremiumFeatureFallback />}
    >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 lg:gap-10 w-full">
            ...
            <div className="w-full flex flex-col gap-4">
              ...
              <div className="space-y-3">
                ...
                {sessionReport.diagnoses &&
                sessionReport.diagnoses.length > 0 ? (
